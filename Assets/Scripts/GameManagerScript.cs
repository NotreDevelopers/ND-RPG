...
public class GameManagerScript : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        if(levelEntranceMappings == null)
        {
            ...
            //Populate
            levelEntranceMappings.Add(1, 2);    // Default entrance point

            levelEntranceMappings.Add(2, 1);    // Bidirectional scene link
        ...
        if(levelEntranceIndexMappings == null)
        {
            ...
            levelEntranceIndexMappings.Add(2, "Test Scene2");
